...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseReference=intent.getIntExtra("CourseReference",R.raw.boje_colors);
        ...
        duration_textview=(TextView)findViewById(R.id.show_duration_textview);
        ...
        ((ImageView)findViewById(R.id.relay)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(MainActivity.this,"App is not playing any song",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    protected void onStart() {
        ...
        {
            Toast.makeText(MainActivity.this,"Can not gain audio focus",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void startCourse()
    {
        if(mMediaPlayer==null) {
            mMediaPlayer= MediaPlayer.create(this,courseReference);
        }
        mMediaPlayer.start();
